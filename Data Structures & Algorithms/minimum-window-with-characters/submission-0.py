class Solution:
    def minWindow(self, s: str, t: str) -> str:
        ...
        need_list = {}
        for char in t:
            need_list[char] = need_list.get(char, 0) + 1

        required = len(need_list)
        have = 0
        ...
        for right_pointer, char in enumerate(s):
            ...
            if char in need_list and wind_dict[char] == need_list[char]:
                have += 1
            ...
            while have == required:
                ...
                if (
                    left_char in need_list
                    and wind_dict[left_char] < need_list[left_char]
                ):
                    have -= 1

                left_pointer += 1

        return "" if min_length == float("inf") else s[min_start_window:min_start_window + min_length]